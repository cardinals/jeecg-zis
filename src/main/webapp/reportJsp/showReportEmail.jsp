...
<%
	...
	//ReportExporter re = new ReportExporter(report,ReportExporter.EXPORT_EXCEL ); // 导出为excel
    //out.print(re.getExportFileName());
	//System.out.println("测试001============="+report);
...
<jsp:include page="toolbarEmail.jsp" flush="false">
 <jsp:param value="<%=report%>" name="report"/> 
</jsp:include>
</div>
