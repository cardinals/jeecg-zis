...
<div class="layui-layout manager">
    ...
    <div class="layui-col-xs2">
     <button id="add" title="新增子节点" onClick="tree_addSubNode()" enterColor="green" class="rootnode layui-btn layui-btn-xs layui-bg-gray"><i class="layui-icon">&#xe654;</i></button>
    </div>
    <div class="layui-col-xs2">
     <button id="ins" title="同级插入节点" onClick="tree_insertNode()" enterColor="green" class="layui-btn layui-btn-xs layui-bg-gray"><i class="layui-icon">&#xe61f;</i></button>
    </div>
    <div class="layui-col-xs2">
     <button id="show" title="预览" onClick="report_nodeClick( currNode )" enterColor="blue" class="rootnode layui-btn layui-btn-xs layui-bg-gray"><i class="layui-icon">&#xe623;</i></button>
    </div>
    <div  class="layui-col-xs2">
     <button id="up" title="节点上移" onClick="tree_moveNode('up')" class="layui-btn layui-btn-xs layui-bg-gray"><i class="layui-icon">&#xe619;</i></button>
    </div>
    <div class="layui-col-xs2">
     <button id="down" title="节点下移" onClick="tree_moveNode('down')" class="layui-btn layui-btn-xs layui-bg-gray"><i class="layui-icon">&#xe61a;</i></button>
    </div>
    <div class="layui-col-xs2">
     <button id="del" title="删除节点" onClick="tree_deleteNode()" enterColor="red" class="layui-btn layui-btn-xs layui-bg-gray"><i class="layui-icon">&#xe640;</i></button>
    </div>
  </div>
</div>
</div>
...
%>
<div id="treeContainer" style="padding-top:10px;height:100%;overflow:scroll;position:relative"><!-- 高度 -->
<%=html%>
</div>
<%
