...
<header class="mui-bar mui-bar-nav">
    <a class="mui-icon mui-icon-back mui-pull-left" href="<%=backTo %>"></a>
    <h1 class="mui-title">报表中心--管理员</h1>
</header>
<body>
<div style="padding-top:10px"><iframe id="mainframe" style="width:100%;height:100%" src="<%=src%>"></iframe></div>
