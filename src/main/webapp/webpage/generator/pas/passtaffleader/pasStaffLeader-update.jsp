...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="pasStaffLeaderController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="goalPerson" name="goalPerson" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${pasStaffLeaderPage.goalPerson}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="dept" name="dept" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${pasStaffLeaderPage.dept}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="totalScore" name="totalScore" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore"  value='${pasStaffLeaderPage.totalScore}'/>
							<span class="Validform_checktip"></span>
