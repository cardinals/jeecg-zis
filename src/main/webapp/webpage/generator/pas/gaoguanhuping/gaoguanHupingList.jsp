...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="gaoguanHupingList" checkbox="true" pagination="false" fitColumns="false" title="高管互评" actionUrl="gaoguanHupingController.do?datagrid" idField="id" fit="true" onLoadSuccess="loadSucessFun" queryMode="group">
   ...
   <!-- start -->
	  ...
	  <t:dgCol title=""  newColumn="true" ></t:dgCol>
	      ...
	      <t:dgToolBar  title="提交"  icon="icon-save" url="gaoguanHupingController.do?saveRows" funname="saveData"></t:dgToolBar>
...
//start
	...
	function loadSucessFun(data){
		var gname = "gaoguanHupingList";
		 $.ajax({
				url:"<%=basePath%>/"+"gaoguanHupingController.do?checkConfirm",
				type:"post",
				dataType:"json",
				success:function(data){
					//tip(data.msg);
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'pasFuzeLeaderController.do?upload', "gaoguanHupingList");
}

//导出
function ExportXls() {
	JeecgExcelExport("pasFuzeLeaderController.do?exportXls","gaoguanHupingList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("pasFuzeLeaderController.do?exportXlsByT","gaoguanHupingList");
}
