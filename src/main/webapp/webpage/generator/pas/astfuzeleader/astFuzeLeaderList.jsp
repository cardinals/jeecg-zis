...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="astFuzeLeaderList" checkbox="true" pagination="true" fitColumns="false" title="部门负责人对上级领导评分" actionUrl="astFuzeLeaderController.do?datagrid" idField="id" fit="true" onLoadSuccess="loadSucessFun" queryMode="group">
   ...
   <t:dgCol title="<b>团队凝聚力(该项满分为25分)&emsp;&emsp;&emsp;</b>"  field="yeji" align="center" queryMode="single"  dictionary="pas_s25" extendParams="editor:'combobox'"  width="220"></t:dgCol>
...
<!-- end -->
	      ...
	      <t:dgToolBar title="提交" icon="icon-save" url="astFuzeLeaderController.do?saveRows" funname="saveData"></t:dgToolBar>
...
<%--    <t:dgCol title="确认状态"  field="confirmFlag"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="astFuzeLeaderController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="astFuzeLeaderController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="astFuzeLeaderController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="astFuzeLeaderController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="astFuzeLeaderController.do?goUpdate" funname="detail"></t:dgToolBar>
 ...
 <script src = "webpage/generator/pas/pasfuzeleader/astFuzeLeaderList.js"></script>		
...
//start
	...
	function loadSucessFun(data){
		var gname = "astFuzeLeaderList";
		 $.ajax({
				url:"<%=basePath%>/"+"astFuzeLeaderController.do?checkConfirm",
				type:"post",
				dataType:"json",
				success:function(data){
					//tip(data.msg);
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'astFuzeLeaderController.do?upload', "astFuzeLeaderList");
}

//导出
function ExportXls() {
	JeecgExcelExport("astFuzeLeaderController.do?exportXls","astFuzeLeaderList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("astFuzeLeaderController.do?exportXlsByT","astFuzeLeaderList");
}
