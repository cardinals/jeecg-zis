...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="pasIarSIndexController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="goalPerson" name="goalPerson" type="text" style="width: 150px" class="inputxt"  ignore="checked"  value='${pasIarSIndexPage.goalPerson}'/>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="totalScore" name="totalScore" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="checked"  value='${pasIarSIndexPage.totalScore}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="comment" name="comment" type="text" style="width: 150px" class="inputxt"  ignore="checked"  value='${pasIarSIndexPage.comment}'/>
							<span class="Validform_checktip"></span>
