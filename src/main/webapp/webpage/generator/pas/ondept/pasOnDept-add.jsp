...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="pasOnDeptController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="goalDept" name="goalDept" type="text" style="width: 150px" class="inputxt"  ignore="checked" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="goalDeptManager" name="goalDeptManager" type="text" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="commentDept" name="commentDept" type="text" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
