...
<div class="easyui-layout" fit="true">
   ...
   <div id="accDiv" class="easyui-accordion" style="padding-right:15px;overflow-x:hidden;box-sizing: border-box;">
		<div title="2018年度部门负责人对上级领导评价表" data-options="iconCls:'icon-ok'" style="overflow:auto;box-sizing: border-box;">
				<table>
					<tr><td>说明：</td></tr>
    ...
    <iframe id="mainList" src="${webRoot}/pasFuzeLeaderController.do?list" frameborder="0" height="60%" width="100%"></iframe>
