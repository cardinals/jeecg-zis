...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="pasEvaluateJiaoyiController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="goalDepart" name="goalDepart" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
