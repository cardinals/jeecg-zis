...
<div class="easyui-layout" fit="true">
   ...
   <div id="accDiv" class="easyui-accordion" style="padding-right:15px;overflow-x:hidden;box-sizing: border-box;">
		<div title="2018年度市场销售支持满意度评价表" data-options="iconCls:'icon-ok'" style="overflow:auto;box-sizing: border-box;">
				<table>
    ...
    <iframe id="mainList" src="${webRoot}/pasSmaSupIndexController.do?list" frameborder="0" height="60%" width="100%"></iframe>
