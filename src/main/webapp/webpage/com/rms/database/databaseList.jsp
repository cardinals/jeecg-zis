...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="databaseList" checkbox="true" pagination="true" fitColumns="true" title="RMS_数据库管理" actionUrl="databaseController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="databaseId"  field="databaseId"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="所在服务"  field="serverId" hidden="true" queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="OS"  field="OSInfo"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="IP"  field="ipInfo"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="类型"  field="dbType"  query="true"  queryMode="single"  dictionary="dbTypes"  width="120"></t:dgCol>
   ...
   <t:dgCol title="RACHA"  field="racorha"  query="true"  queryMode="single"  dictionary="racha"  width="120"></t:dgCol>
   <t:dgCol title="管理员"  field="administrator"  query="true"  queryMode="single"  dictionary="user"  width="120"></t:dgCol>
   <t:dgCol title="上线时间"  field="launchDate"  formatter="yyyy-MM-dd"  query="true"  queryMode="group"  width="120"></t:dgCol>
