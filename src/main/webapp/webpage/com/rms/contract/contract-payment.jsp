...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="paymentList" checkbox="false" pagination="true" fitColumns="true" title="RMS_付款管理" actionUrl="paymentController.do?datagridForPayment&paramId=${contractPage.id}" idField="id" fit="true" queryMode="group">
   <t:dgCol title="付款编号"  field="paymentId"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="综合编号"  field="contractId" hidden="true"  queryMode="group"  dictionary="rms_contract_jeecg,contract_id,contract_no"  width="120"></t:dgCol>
   <t:dgCol title="合同名称"  field="contractName" hidden="true"  queryMode="single"  dictionary="rms_contract_jeecg,contract_id,name"  width="120"></t:dgCol>
