...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="addressController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="addrdetails" name="addrdetails" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="addrshort" name="addrshort" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
