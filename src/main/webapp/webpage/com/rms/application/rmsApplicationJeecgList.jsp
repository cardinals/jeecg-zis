...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="rmsApplicationJeecgList" checkbox="true" pagination="true" fitColumns="true" title="应用管理" actionUrl="rmsApplicationJeecgController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="所在设备_old"  field="container" hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="serverId"  field="serverId" hidden="true"  width="120"></t:dgCol>
    <t:dgCol title="所在设备"  field="hardWareName" queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="OS"  field="OSInfo"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="ip"  field="ipInfo"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="类型"  field="appType"  query="true"  queryMode="single"  dictionary="appliType"  width="120"></t:dgCol>
   <t:dgCol title="状态"  field="status"  query="true"  queryMode="single"  dictionary="applstate"  width="120"></t:dgCol>
   <t:dgCol title="应用描述"  field="appInfo"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="管理员"  field="administrator" dictionary="user" query="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="上线日期"  field="launchDate"  formatter="yyyy-MM-dd"  query="true"  queryMode="group"  width="120"></t:dgCol>
