...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="userTestController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="username" name="username" type="text" style="width: 150px" class="inputxt" 		validType="user_test,username,id" datatype="*" ignore="ignore" />
			...
			<td class="value">
		     	 <input id="sex" name="sex" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="userTestController.do?userTestLineList&uSERNAME=${userTestPage.uSERNAME}" icon="icon-search" title="母子表关联" id="userTestLine"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
 ...
 <script src = "webpage/com/jeecg/user_test/userTest.js"></script>
