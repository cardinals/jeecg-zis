 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="resumeId" name="resumeId" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zpGradePage.resumeId}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="grade1" name="grade1" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore"  value='${zpGradePage.grade1}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="jpStatus" name="jpStatus" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zpGradePage.jpStatus}'/>
							<span class="Validform_checktip"></span>
