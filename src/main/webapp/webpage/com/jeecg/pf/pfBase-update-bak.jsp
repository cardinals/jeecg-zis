 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${pfBasePage.name}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="jijinCode" name="jijinCode" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${pfBasePage.jijinCode}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="jijinManager" name="jijinManager" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${pfBasePage.jijinManager}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="jijinManagerHis" name="jijinManagerHis" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${pfBasePage.jijinManagerHis}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value"  colspan="3" >
						  	 	<textarea id="remarks" style="width:500px;height:80px;" class="inputxt" rows="6" name="remarks"  ignore="ignore" >${pfBasePage.remarks}</textarea>
							<span class="Validform_checktip"></span>
