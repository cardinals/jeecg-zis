...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="bankAccountList" checkbox="true" fitColumns="false" title="银行账户信息总表" actionUrl="bankAccountController.do?datagrid" idField="id" fit="true" queryMode="group"
  queryBuilder="true"
