...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="bankAccountController.do?doCheck" >
		...
		<table style="width:320px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
									<t:dictSelect field="status" type="radio" typeGroupCode="fuhe" defaultVal="Y" hasLabel="false"  title="审核状态" ></t:dictSelect>     
