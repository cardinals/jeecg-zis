...
<html>
 <head>
  ...
  $(function(){
	  ...
	  var dictSelects = document.getElementsByTagName('t:dictSelect');
	  for(var i=0; i<controls.length; i++){
	   // if(controls[i].type=='text'){
	     controls[i].setAttribute("readOnly","readOnly");
	    //}
	  }
	  for(var i=0; i<dictSelects.length; i++){
		     controls[i].setAttribute("readOnly","readOnly");
		     
		  }
	  $("#procomment").removeAttr('readonly');//移除readonly属性
  });
  </script>
   <script src = "webpage/com/jeecg/weekrep/orgptFucmodWeekrep.js">
  </script>	
 </head>
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="visitdate" name="visitdate" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${orgptFucmodWeekrepPage.visitdate}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						-->
							 <!-- 代码生成用的 -->
							<select id="targetorginwk"  disabled="false" name="targetorginwk" ignore="ginore" value="${orgptFucmodWeekrepPage.targetorginwk}"></select>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									<t:dictSelect readonly="readonly" field="accessflag" type="list"  typeGroupCode="01NY"   defaultVal="${orgptFucmodWeekrepPage.accessflag}" hasLabel="false"  title="是否准入" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect readonly="readonly" field="cooperationpoint" type="list"  typeGroupCode="cooperapo"   defaultVal="${orgptFucmodWeekrepPage.cooperationpoint}" hasLabel="false"  title="业务合作点" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
