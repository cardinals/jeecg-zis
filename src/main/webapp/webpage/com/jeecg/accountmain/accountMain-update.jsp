...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="accountMainController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="accountNumber" name="accountNumber" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.accountNumber}'/>
			...
			<td class="value">
		     	 <input id="acountName" name="acountName" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.acountName}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="acountFullname" name="acountFullname" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.acountFullname}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="acountShortname" name="acountShortname" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.acountShortname}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="kaihuDate" name="kaihuDate" type="text" style="width: 150px"  		datatype="*" ignore="ignore"  value='<fmt:formatDate value='${accountMainPage.kaihuDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="acountStatus" name="acountStatus" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.acountStatus}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="acountInterestRate" name="acountInterestRate" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${accountMainPage.acountInterestRate}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="interestRateDate" name="interestRateDate" type="text" style="width: 150px"  		datatype="*" ignore="ignore"  value='<fmt:formatDate value='${accountMainPage.interestRateDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="isLiushui" name="isLiushui" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.isLiushui}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="onlineProduct" name="onlineProduct" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.onlineProduct}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="bigZhifu" name="bigZhifu" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${accountMainPage.bigZhifu}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="isPreEnd" name="isPreEnd" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${accountMainPage.isPreEnd}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="contact" name="contact" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.contact}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="contactType" name="contactType" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="ignore"  value='${accountMainPage.contactType}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="lineHanghao" name="lineHanghao" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${accountMainPage.lineHanghao}'/>
				<span class="Validform_checktip"></span>
