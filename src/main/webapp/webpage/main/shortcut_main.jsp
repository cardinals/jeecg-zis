...
<tr>
    ...
    <!--
        ...
        <%-- <div style="position: absolute; top: 75px; left: 33px;">中融基金信息技术部 <span style="letter-spacing: -1px;"> <t:mutiLang langKey="system.version.number"/></span></div> --%>
    </td>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="#" title="中融基金智能管理平台<t:mutiLang langKey="system.version.number"/>"><%-- 中融基金信息技术部  <t:mutiLang langKey="system.version.number"/> --%></a>
            (推荐谷歌浏览器，获得更快响应速度) 技术支持:
            <a href="#" title="中融基金信息技术部  <t:mutiLang langKey="system.version.number"/>">中融基金信息技术部 <%-- <t:mutiLang langKey="system.version.number"/> --%></a>
        </span>
    </div>
</div>
