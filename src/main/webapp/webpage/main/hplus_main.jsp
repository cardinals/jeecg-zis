...
<head>
    ...
    <meta name="keywords" content="中融基金智能管理平台3">
    <meta name="description" content="中融基金智能管理平台">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                                 <span>
                                <!--  <a href="/jeecg">  -->
                             <!--   20180815  <img alt="image" width="180" height="68" src="plug-in/login/images/jeecg-aceplus.png" /> -->
                              <!--    </a> -->
                                 </span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header" style="height: 45px;width:22%"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                ...
                <div><img alt="image" width="332" height="36" src="plug-in/login/images/jeecg-aceplus.png" style="
					position:  relative;
					    left: 130px;
					    top: 9px;
					">
...
-->                
                <ul class="nav navbar-top-links navbar-right" style="margin-top: -37px;">
                   <%--  <li class="dropdown">
...
<!--                             <li><a href="javascript:toJeecgYun()">云应用中心</a></li>
 -->                            <!-- <li><a href="http://yun.jeecg.org" target="_blank">云应用中心</li> -->
        ...
        <div class="footer" style="border-top:none;">
            <div class="pull-right">&copy; <%-- <t:mutiLang langKey="system.version.number"/> --%> 中融基金
            </div> 
        </div>        
    </div>
    <!--右侧部分结束-->
...
<%-- <%@include file="/context/layui.jsp"%> 
 --%><script>
	...
	/* 		 var  tourl="loginController.do?logoutAndCloseTab";//获取银行实体
    ...
    $(document).ready(function(){
    	//$("#side-menu>li:eq(1) a:eq(0)").click(); 
    	//$("#side-menu>li:eq(1) a:eq(0)").click(); 
    	//$("#side-menu>li:eq(2) a:eq(0)").click(); 
        //加载公告
 ...
 <script type="text/javascript">
	    ...
	    function iosIframeWidthBug(){
	        ...
	        //获取子iframe
	        //alert('fix')
	        var iframebody = document.getElementById('iframe0').contentWindow.document.body;
