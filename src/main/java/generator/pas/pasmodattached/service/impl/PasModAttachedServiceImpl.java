package generator.pas.pasmodattached.service.impl;
...
@Service("pasModAttachedService")
@Transactional
public class PasModAttachedServiceImpl extends CommonServiceImpl implements PasModAttachedServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(PasModAttachedEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(PasModAttachedEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(PasModAttachedEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(PasModAttachedEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("username", t.getUsername());
		map.put("realname", t.getRealname());
		map.put("rolecode", t.getRolecode());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,PasModAttachedEntity t){
 		...
 		sql  = sql.replace("#{rolename}",String.valueOf(t.getRolename()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("pas_mod_attached",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
