package generator.pas.gaoguanhuping.entity;
 ...
 */
@Entity
@Table(name = "pas_gaoguan_huping", schema = "")
@SuppressWarnings("serial")
public class GaoguanHupingEntity implements java.io.Serializable {
	/**主键*/
	...
	private List<GaoguanHupingEntity> gghpList ;
	@Transient
	public List<GaoguanHupingEntity> getGghpList() {
		return gghpList;
	}

	public void setGghpList(List<GaoguanHupingEntity> gghpList) {
