package generator.pas.aststafflead.entity;
 ...
 */
@Entity
@Table(name = "pas_ast_stafflead", schema = "")
@SuppressWarnings("serial")
public class AstStaffleadEntity implements java.io.Serializable {
	/**主键*/
	...
	private List<AstStaffleadEntity> astStaffleadList ;
	
	
	@Transient
	public List<AstStaffleadEntity> getAstStaffleadList() {
		return astStaffleadList;
	}

	public void setAstStaffleadList(List<AstStaffleadEntity> astStaffleadList) {
		this.astStaffleadList = astStaffleadList;
	}
