package generator.pas.pasfuzeleader.entity;
 ...
 */
@Entity
@Table(name = "pas_fuze_leader", schema = "")
@SuppressWarnings("serial")
public class PasFuzeLeaderEntity implements java.io.Serializable {
	/**主键*/
	...
	/**业绩完成情况*/
	@Excel(name="业绩完成情况",width=15,dicCode="pas_s60")
	private java.lang.Integer yeji;
	/**团队领导力*/
	@Excel(name="团队领导力",width=15,dicCode="pas_s15")
	private java.lang.Integer teamLead;
	/**发展创新力*/
	@Excel(name="发展创新力",width=15,dicCode="pas_s15")
	private java.lang.Integer deveCreate;
	/**诚信敬业度*/
	@Excel(name="诚信敬业度",width=15,dicCode="pas_s10")
	...
	@Column(name ="YEJI",nullable=true,length=32)
	...
	@Column(name ="TEAM_LEAD",nullable=true,length=32)
	...
	@Column(name ="DEVE_CREATE",nullable=true,length=32)
	...
	@Column(name ="SINCERITY_HARDWORK",nullable=true,length=32)
	...
	public void setConfirmFlag(java.lang.String confirmFlag){
	 ...
	 private List<PasFuzeLeaderEntity> pasLeadList ;
	@Transient
	public List<PasFuzeLeaderEntity> getPasLeadList() {
		return pasLeadList;
	}

	public void setPasLeadList(List<PasFuzeLeaderEntity> pasLeadList) {
		this.pasLeadList = pasLeadList;
	}
