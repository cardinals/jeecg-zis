package generator.pas.ast.dept.entity;
 ...
 */
@Entity
@Table(name = "pas_ast_dept", schema = "")
@SuppressWarnings("serial")
public class PasAstDeptEntity implements java.io.Serializable {
	/**主键*/
	...
	/**专业水平*/
	@Excel(name="专业水平",width=15,dicCode="pas_s30")
	...
	@Column(name ="GOAL_DEPT_MANAGER",nullable=true,length=32)
    ...
    private List<PasAstDeptEntity> pasAstDeptList ;
	
    @Transient
	public List<PasAstDeptEntity> getPasAstDeptList() {
		return pasAstDeptList;
	}

	public void setPasAstDeptList(List<PasAstDeptEntity> pasAstDeptList) {
		this.pasAstDeptList = pasAstDeptList;
	}
}
