package generator.pas.astfuzeleader.entity;
 ...
 */
@Entity
@Table(name = "ast_fuze_leader", schema = "")
@SuppressWarnings("serial")
public class AstFuzeLeaderEntity implements java.io.Serializable {
	/**主键*/
	...
	/**业绩完成情况*/
	@Excel(name="业绩完成情况",width=15,dicCode="pas_s25")
	private java.lang.Integer yeji;
	/**团队领导力*/
	@Excel(name="团队领导力",width=15,dicCode="pas_s25")
	private java.lang.Integer teamLead;
	/**发展创新力*/
	@Excel(name="发展创新力",width=15,dicCode="pas_s25")
	private java.lang.Integer deveCreate;
	/**诚信敬业度*/
	@Excel(name="诚信敬业度",width=15,dicCode="pas_s25")
	...
	public void setConfirmFlag(java.lang.String confirmFlag){
	 ...
	 private List<AstFuzeLeaderEntity> pasLeadList ;
	@Transient
	public List<AstFuzeLeaderEntity> getPasLeadList() {
		return pasLeadList;
	}

	public void setPasLeadList(List<AstFuzeLeaderEntity> pasLeadList) {
