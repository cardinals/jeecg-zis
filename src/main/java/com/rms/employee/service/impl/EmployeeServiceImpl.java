package com.rms.employee.service.impl;
...
public class EmployeeServiceImpl extends CommonServiceImpl implements EmployeeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(EmployeeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(EmployeeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(EmployeeEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(EmployeeEntity t){
		...
		map.put("employee_no", t.getEmployeeNo());
		map.put("employee_name", t.getEmployeeName());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,EmployeeEntity t){
 		...
 		sql  = sql.replace("#{employee_no}",String.valueOf(t.getEmployeeNo()));
 		sql  = sql.replace("#{employee_name}",String.valueOf(t.getEmployeeName()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("rms_employee_oa",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
