package com.jeecg.raiseaccountuse.entity;
...
/**   
 * @Title: Entity
 * @Description: 募集账户使用情况明细
 * @author onlineGenerator
 * @date 2018-07-24 09:33:21
 * @version V1.0   
 *
 */
@Entity
@Table(name = "raise_account_use", schema = "")
@SuppressWarnings("serial")
public class RaiseAccountUseEntity implements java.io.Serializable {
	/**主键*/
	...
	/**结息状态2*/
    @Excel(name="结息状态2",width=15)
	private java.lang.String jiexiStatus2;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  结息状态2
	 */
	
	@Column(name ="JIEXI_STATUS2",nullable=true,length=32)
	public java.lang.String getJiexiStatus2(){
		return this.jiexiStatus2;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  结息状态2
	 */
	public void setJiexiStatus2(java.lang.String jiexiStatus2){
		this.jiexiStatus2 = jiexiStatus2;
	}
