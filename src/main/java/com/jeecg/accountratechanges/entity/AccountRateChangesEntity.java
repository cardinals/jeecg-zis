package com.jeecg.accountratechanges.entity;
 ...
 */
@Entity
@Table(name = "account_rate_changes", schema = "")
@SuppressWarnings("serial")
public class AccountRateChangesEntity implements java.io.Serializable {
	/**主键*/
