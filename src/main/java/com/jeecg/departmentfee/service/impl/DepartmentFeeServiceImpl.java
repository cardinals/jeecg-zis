package com.jeecg.departmentfee.service.impl;
...
@Service("departmentFeeService")
@Transactional
public class DepartmentFeeServiceImpl extends CommonServiceImpl implements DepartmentFeeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(DepartmentFeeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(DepartmentFeeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(DepartmentFeeEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(DepartmentFeeEntity t){
		...
		map.put("fee_amount", t.getFeeAmount());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DepartmentFeeEntity t){
 		...
 		sql  = sql.replace("#{fee_amount}",String.valueOf(t.getFeeAmount()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("department_fee",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
