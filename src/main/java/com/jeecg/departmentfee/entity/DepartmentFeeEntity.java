package com.jeecg.departmentfee.entity;
 ...
 */
@Entity
@Table(name = "department_fee", schema = "")
@SuppressWarnings("serial")
public class DepartmentFeeEntity implements java.io.Serializable {
	/**主键*/
	...
	/**划款金额*/
	@Excel(name="划款金额",width=15)
	private java.lang.String feeAmount;
	/**划款说明*/
	@Excel(name="划款说明",width=15)
	...
	/**费用发票*/
	@Excel(name="费用发票",width=15,dicCode="FPYN")
	private java.lang.String feeFapiao;
	/**费用经办人*/
	@Excel(name="费用经办人",width=15)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  划款金额
	 */

	@Column(name ="FEE_AMOUNT",nullable=true,length=32)
