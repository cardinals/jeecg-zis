package com.jeecg.maintest.entity;
 ...
 */
@Entity
@Table(name = "main_test", schema = "")
@SuppressWarnings("serial")
public class MainTestEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="MAIN_NAME",nullable=true,length=32)
	...
	@Column(name ="MAIN_AGE",nullable=true,length=32)
	public java.lang.String getMainAge(){
		return this.mainAge;
	}
	 ...
	 */
	public void setMainAge(java.lang.String mainAge){
