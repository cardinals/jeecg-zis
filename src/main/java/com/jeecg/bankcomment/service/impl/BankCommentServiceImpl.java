package com.jeecg.bankcomment.service.impl;
...
@Service("bankCommentService")
@Transactional
public class BankCommentServiceImpl extends CommonServiceImpl implements BankCommentServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BankCommentEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BankCommentEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BankCommentEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BankCommentEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BankCommentEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("bank_comment",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
