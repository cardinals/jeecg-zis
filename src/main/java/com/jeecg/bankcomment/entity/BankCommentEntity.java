package com.jeecg.bankcomment.entity;
 ...
 */
@Entity
@Table(name = "bank_comment", schema = "")
@SuppressWarnings("serial")
public class BankCommentEntity implements java.io.Serializable {
	/**主键*/
	...
	/**意见修改时间*/
	@Excel(name="意见修改时间",width=15,format = "yyyy-MM-dd")
