package com.jeecg.bankaccount.entity;
 ...
 */
@Entity
@Table(name = "bank_account", schema = "")
...
public class BankAccountEntity implements java.io.Serializable {
	...
	@Column(name ="FILE",nullable=true,length=32)
	...
	@Column(name ="TODATE",nullable=true,length=32)
	 ...
	 */
	@Column(name ="fuhe_status",nullable=true,length=255)
