package com.jeecg.raiseaccountusetemp.entity;
 ...
 */
@Entity
@Table(name = "raise_account_usetemp", schema = "")
@SuppressWarnings("serial")
public class RaiseAccountUsetempEntity implements java.io.Serializable {
	/**id*/
