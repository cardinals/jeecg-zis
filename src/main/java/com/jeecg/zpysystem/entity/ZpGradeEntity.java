 ...
 */
@Entity
@Table(name = "jform_zp_b_grade", schema = "")
@SuppressWarnings("serial")
public class ZpGradeEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.String jpStatus;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  录用状态
	 */

	@Column(name ="JP_STATUS",nullable=true,length=32)
	public java.lang.String getJpStatus(){
		return this.jpStatus;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  录用状态
	 */
	public void setJpStatus(java.lang.String jpStatus){
