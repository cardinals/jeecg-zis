...
@Service("cushionFunds3")
public class CushionFunds3 extends CommonServiceImpl implements Job {
	/**
	...
	public void run() {
		...
		//if(true){	
		   ...
		   String  mailBody = "邮件发送内容-测试";
	        //收件人、抄送人 配置到数据库中
		    ReportEmailEntity reportEmail = reportEmailService.findUniqueByProperty(ReportEmailEntity.class, "reportName", "dianzijin3");
