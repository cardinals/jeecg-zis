...
public interface SystemService extends CommonService{
	...
	/**
	 * 	以当前日期currentDate 查询表tableName 中 字段maxField，日期最大的那个值
	 * @param currentDate
	 * @param maxField 内容为日期格式
	 * @param tableName
	 * @return
	 */
	public BigDecimal getIdForCurrentDate(String currentDate,String maxField,String tableName);
	/**
 	 * 方法描述:  查询数据字典
 	 * 作    者： yiming.zhang
