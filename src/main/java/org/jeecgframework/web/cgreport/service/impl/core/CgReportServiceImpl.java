...
public class CgReportServiceImpl extends CommonServiceImpl implements
	...
	@Override
	public List<Map<String, Object>> queryByCgReportProcedure(String sql,String dbkey,Map params, int page, int rows) {

		List<Map<String, Object>> result = null;
//		sql=sql.replace("{","").replace("}", "");
		result = DynamicDBUtil.findListProcedure(dbkey,sql,params,page,rows);
